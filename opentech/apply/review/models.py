...
from opentech.apply.review.options import YES, NO, MAYBE, RECOMMENDATION_CHOICES, VISIBILITY, PRIVATE
...
class Review(ReviewFormFieldsMixin, BaseStreamForm, AccessFormData, models.Model):
    ...
    visibility = models.CharField(choices=VISIBILITY.items(), default=PRIVATE, max_length=10)
