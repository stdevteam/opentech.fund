...
class TestTemplateTags(TestCase):
    ...
    def test_submission_tags(self):
        ...
        output = template.render(context)
        self.assertEqual(output, f'Lorem ipsum dolor <a href="/apply/submissions/{submission.id}/">{submission.title} <span class="mid-grey-text">#{submission.id}</span></a> sit amet.')
